 ...
 *
 * Contains pure functions for QQ Bot inbound message text processing:
 * internal-marker stripping, ref-index extraction, face-tag rendering,
 * and attachment-summary normalization.
 */

import type { RefAttachmentSummary } from "./ref-attachments.js";
...
/** QQ message type for quote-reply messages. */
...
/** Estimate Base64 decoded byte size. */
