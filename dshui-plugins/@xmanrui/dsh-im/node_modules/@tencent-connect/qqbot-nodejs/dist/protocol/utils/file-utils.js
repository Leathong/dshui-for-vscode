 ...
 * of the host application (e.g. an OpenClaw plugin) and should be
 * implemented at the integration layer.
 */
...
export const MEDIA_FILE_TYPE_INFO = {
 ...
 */
function lowercaseExt(filePath) {
