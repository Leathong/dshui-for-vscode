...
function FileRow(props) {
    ...
    return (_jsx("li", { className: "dsh-mod-file", children: _jsxs("div", { className: "dsh-mod-file-row", children: [_jsxs("button", { type: "button", className: "dsh-mod-file-path", onClick: onOpenReview, title: `${change.absolutePath} · ${t('openInEditor')}`, children: [_jsx("span", { className: `dsh-mod-status-dot dsh-mod-status-${change.status}` }), change.path] }), _jsx("button", { type: "button", className: "dsh-mod-link", onClick: onOpenFile, title: t('openAt'), "aria-label": t('openAt'), children: _jsx(IconRightUpOutline16, { size: 8 }) }), _jsx("span", { className: "dsh-mod-status", children: t(`status.${change.status}`) }), _jsxs("span", { className: "dsh-mod-actions", children: [_jsx(Tooltip, { label: t('dock.accept'), side: "bottom", children: _jsx("button", { type: "button", className: "dsh-mod-action", onClick: onAccept, disabled: busy, "aria-label": t('dock.accept'), children: _jsx(IconCheckOutline14, {}) }) }), fileConfirming ? undoConfirm : (_jsx(Tooltip, { label: t('dock.undo'), side: "bottom", children: _jsx("button", { type: "button", className: "dsh-mod-action", onClick: onRequestUndo, disabled: busy, "aria-label": t('dock.undo'), children: busy ? _jsx("span", { className: "dsh-mod-spin", children: "\u25CC" }) : _jsx(IconUndoOutline14, {}) }) }))] })] }) }));
}
